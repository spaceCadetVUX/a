...
<Picker.Item label="Please select ..." value="" />
          ...
          <Text style={styles.terms}>
            2. I agree that THACO (and its affiliates, partners of THACO) may collect, use, modify, store, and copy my information and provide it to relevant third parties for purposes of customer service, marketing, research, etc.*
          </Text>
